...
CREATE TABLE ENCRYPTION_KEYS (
    ...
    PRIVATE_KEY     CLOB,
    AES_KEY         RAW(32),                      -- khóa AES-256 cho mã hóa đối xứng
...
ALTER TABLE STUDENTS ADD CONSTRAINT CK_STUDENTS_GENDER CHECK (GENDER IN (N'Nam',N'Nữ',N'Khác'));
...
CREATE TABLE ACTIVITIES (
    ...
    CREATED_AT      TIMESTAMP(6)  DEFAULT SYSTIMESTAMP NOT NULL,
    REGISTRATION_START       TIMESTAMP(6),
...
-- =========================================================
-- 18) FEEDBACK_ATTACHMENTS (File đính kèm)
-- =========================================================
