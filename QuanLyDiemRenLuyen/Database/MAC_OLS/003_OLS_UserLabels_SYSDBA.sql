...
BEGIN
    ...
    BEGIN
        INSERT INTO QLDIEMRENLUYEN.AUDIT_EVENTS(EVENT_CATEGORY, EVENT_TYPE, PERFORMED_BY, DESCRIPTION)
        VALUES ('SECURITY', 'OLS_SESSION_SET', p_user_id, 'OLS session set for role: ' || p_role);
        COMMIT;
    EXCEPTION
