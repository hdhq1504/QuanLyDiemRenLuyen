...
-- System/Audit tables
GRANT ALL ON AUDIT_EVENTS TO ROLE_ADMIN;
GRANT ALL ON AUDIT_CHANGE_LOGS TO ROLE_ADMIN;
GRANT ALL ON AUDIT_CONFIG TO ROLE_ADMIN;
GRANT ALL ON PASSWORD_RESET_TOKENS TO ROLE_ADMIN;
GRANT ALL ON SESSION_TOKENS TO ROLE_ADMIN;
...
GRANT SELECT ON FEEDBACK_ATTACHMENTS TO ROLE_READONLY;
...
GRANT SELECT ON CLASS_SCORE_PERMISSIONS TO ROLE_READONLY;
GRANT SELECT ON AUDIT_EVENTS TO ROLE_READONLY;
GRANT SELECT ON AUDIT_CHANGE_LOGS TO ROLE_READONLY;
