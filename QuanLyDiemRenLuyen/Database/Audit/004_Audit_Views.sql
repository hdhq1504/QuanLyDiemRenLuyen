...
SELECT 
    ae.ID AS ACTION_ID,
    ae.EVENT_TYPE AS ACTION_TYPE,
    ae.DESCRIPTION AS ACTION_DESC,
    ae.ENTITY_TYPE,
    ae.ENTITY_ID,
    ae.PERFORMED_BY,
    u.FULL_NAME AS PERFORMER_NAME,
    ae.EVENT_AT_UTC AS PERFORMED_AT,
    ae.STATUS,
    ae.ERROR_MESSAGE
FROM AUDIT_EVENTS ae
LEFT JOIN USERS u ON u.MAND = ae.PERFORMED_BY
WHERE ae.EVENT_CATEGORY = 'BUSINESS'
...
-- Hành động từ AUDIT_EVENTS (BUSINESS category)
SELECT 
